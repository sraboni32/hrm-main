...
class DashboardController extends Controller
{
    ...
    public function dashboard_admin()
    {
        ...
        foreach ($dates_deposits as $key => $value) {
            ...
            $task_status =  Task::groupBy('status')
            ->get([
    ...
    public function dashboard_employee()
    {
        ...
        $count_projects = EmployeeProject::join('projects', 'employee_project.project_id', '=', 'projects.id')
            ->where('employee_project.employee_id', $user_auth->id)
            ->where('projects.deleted_at', '=', null)
            ->count();
        $count_tasks = EmployeeTask::join('tasks', 'employee_task.task_id', '=', 'tasks.id')
            ->where('employee_task.employee_id', $user_auth->id)
    ...
    public function dashboard_client()
    {
        ...
        $count_tasks = Task::whereIn('project_id' , $project_id)
        ->count();
