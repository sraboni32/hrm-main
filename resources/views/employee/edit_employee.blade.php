            ...
            <form @submit.prevent="Update_Employee()">
                <div class="card-body">
                    <div class="form-row ">
                        ...
                        <div class="form-group col-md-6">
                            <label for="total_leave" class="ul-form__label">{{ __('translate.Annual_Leave') }}</label>
                        ...
                        <div class="form-group col-md-6">
                            <label for="sick_leave" class="ul-form__label">Sick Leave</label>
                            <input type="number" class="form-control" id="sick_leave"
                                placeholder="Enter Sick Leave" v-model="employee.sick_leave">
                            <span class="error" v-if="errors && errors.sick_leave">
                                @{{ errors.sick_leave[0] }}
                            </span>
                        </div>
                        <div class="form-group col-md-6">
                            <label for="casual_leave" class="ul-form__label">Casual Leave</label>
                            <input type="number" class="form-control" id="casual_leave"
                                placeholder="Enter Casual Leave" v-model="employee.casual_leave">
                            <span class="error" v-if="errors && errors.casual_leave">
                                @{{ errors.casual_leave[0] }}
                            </span>
                        </div>
    ...
    methods: {
        ...
        Update_Employee() {
            ...
            axios.put("/employees/" + self.employee.id, {
                ...
                sick_leave: self.employee.sick_leave,
                casual_leave: self.employee.casual_leave,
            }).then(response => {
