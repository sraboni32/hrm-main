                                    ...
                                    <div class="card-header">{{ __('translate.Reports') }}</div>
                                        <div class="card-body">
                                            <div class="row">
                                                ...
                                                <div class="col-md-12">
                                                    <label class="checkbox checkbox-outline-primary">
                                                        <input type="checkbox" v-model="permissions" value="approve_salary_disbursement">
                                                        <span>Approve Salary Disbursement</span>
                                                        <span class="checkmark"></span>
                                                        <small class="text-muted d-block">Allows user to approve salary reports that have been reviewed by employees.</small>
                                                    </label>
                                                </div>
                                                {{-- Mark Salary Paid --}}
                                                <div class="col-md-12">
                                                    <label class="checkbox checkbox-outline-primary">
                                                        <input type="checkbox" v-model="permissions" value="mark_salary_paid">
                                                        <span>Mark Salary Paid</span>
                                                        <span class="checkmark"></span>
                                                        <small class="text-muted d-block">Allows user to mark approved salary reports as paid.</small>
                                                    </label>
                                                </div>
