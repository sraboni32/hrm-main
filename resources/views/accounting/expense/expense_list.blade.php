...
<script type="text/javascript">
    $(function () {
      "use strict";
        ...
        // Initialize expense table with mobile configuration
        window.DataTablesMobileConfig.initTable('#expense_table', 'accounting', {
            ...
            columnDefs: [
                ...
                { targets: 2, responsivePriority: 1 }, // Account name
                { targets: 3, responsivePriority: 3 }, // Reference
                { targets: 4, responsivePriority: 2 }, // Date
                { targets: 5, responsivePriority: 4 }, // Amount
                { targets: 6, responsivePriority: 10000 }, // Category
                { targets: 7, responsivePriority: 10001 }, // Payment method
