...
<script type="text/javascript">
    $(function () {
      "use strict";
        ...
        // Initialize account table with mobile configuration
        window.DataTablesMobileConfig.initTable('#account_table', 'accounting', {
            ...
            columnDefs: [
                ...
                { targets: 3, responsivePriority: 3 }, // Account number
                { targets: 4, responsivePriority: 2 }, // Initial balance
                { targets: 5, responsivePriority: 4 }, // Total balance
                { targets: 6, responsivePriority: 10000 }, // Note
