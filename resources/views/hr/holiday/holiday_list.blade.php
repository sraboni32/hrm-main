...
<script type="text/javascript">
    $(function () {
      "use strict";
        ...
        // Initialize holiday table with mobile configuration
        window.DataTablesMobileConfig.initTable('#holiday_list_table', 'hr', {
            order: [[2, 'asc']], // Sort by date
            columnDefs: [
                { targets: 0, className: 'select-checkbox', responsivePriority: 1 },
                { targets: 1, responsivePriority: 1 }, // Holiday title
                { targets: 2, responsivePriority: 2 }, // Date
                { targets: 3, responsivePriority: 10000 }, // Company
                { targets: 4, responsivePriority: 10001 }, // Description
