...
<div class="side-content-wrap">
    <div class="sidebar-left open rtl-ps-none" data-perfect-scrollbar data-suppress-scroll-x="true">
        ...
        <div class="mobile-sidebar-header d-block d-lg-none">
            <div class="d-flex align-items-center justify-content-between p-3">
                <div class="logo">
                    @if($setting && $setting->logo && file_exists(public_path('assets/images/'.$setting->logo)))
                        <img src="{{asset('assets/images/'.$setting->logo)}}"
                             ...
                             class="logo-img img-fluid mobile-logo"
                ...
                <button class="btn btn-link mobile-sidebar-close" id="mobile-sidebar-close">
                    <i class="i-Close text-muted"></i>
                </button>
            </div>
            <hr class="m-0">
        </div>
        <ul class="navigation-left">
            ...
            @if (auth()->user()->role_users_id != 1 && auth()->user()->role_users_id != 3)
                ...
                <li class="nav-item {{ request()->is('my-salary-disbursements') ? 'active' : '' }}">
                    <a class="nav-item-hold" href="{{ route('salary_disbursement.employee_index') }}">
                        <i class="nav-icon i-Money-Bag"></i>
                        <span class="nav-text">{{ __('translate.My_Salary_Disbursements') }}</span>
                    </a>
                    <div class="triangle"></div>
                </li>
            @endif
            ...
            @if (auth()->user()->role_users_id == 1)
                <li class="nav-item {{ request()->is('ai-chat*') ? 'active' : '' }}">
                    <a class="nav-item-hold" href="{{ route('ai_chat.index') }}">
                        <i class="nav-icon i-Robot"></i>
                        <span class="nav-text">{{ __('translate.AI_HR_Assistant') }}</span>
                    </a>
                    <div class="triangle"></div>
                </li>
            @endif
    ...
    <div class="sidebar-left-secondary rtl-ps-none" data-perfect-scrollbar data-suppress-scroll-x="true">
        <!-- Mobile sub-sidebar header -->
        <div class="mobile-subsidebar-header d-block d-lg-none">
            <h5 class="mobile-subsidebar-title" id="mobile-subsidebar-title">Menu</h5>
            <button class="mobile-subsidebar-back" id="mobile-subsidebar-back">
        ...
        @yield('childNav')
        <!-- Submenu Employee -->
        <ul class="childNav" data-parent="employees" data-title="{{ __('translate.Employees') }}">
            @can('employee_add')
                <li class="nav-item">
        ...
        <!-- Submenu Attendance -->
        <ul class="childNav" data-parent="attendances" data-title="{{ __('translate.Attendance') }}">
            @can('attendance_view')
                <li class="nav-item">
        ...
        <ul class="childNav" data-parent="core" data-title="{{ __('translate.Company_Management') }}">
    ...
    auth()->user()->can('payment_method'))
        ...
        <!-- Submenu HR -->
        <ul class="childNav" data-parent="hr" data-title="{{ __('translate.Hr_Management') }}">
    ...
    auth()->user()->can('arrangement_type'))
            ...
            <li class="nav-item">
                <a class="{{ Route::currentRouteName() == 'job_vacancies.admin.index' ? 'open' : '' }}"
                    href="{{ route('job_vacancies.admin.index') }}">
                    <i class="nav-icon i-Business-Mens"></i>
