...
<script type="text/javascript">
    ...
    // Initialize training table with mobile configuration
    window.DataTablesMobileConfig.initTable('#training_list_table', 'hr', {
        order: [[2, 'asc']], // Sort by training title
        columnDefs: [
            { targets: 0, className: 'control', responsivePriority: 1 },
            { targets: 1, className: 'select-checkbox', responsivePriority: 2 },
            { targets: 2, responsivePriority: 1 }, // Training title
            { targets: 3, responsivePriority: 10000 }, // Company
            { targets: 4, responsivePriority: 3 }, // Trainer
            { targets: 5, responsivePriority: 4 }, // Employee
