                ...
                columns: [
                    ...
                    {data: 'priority', name: 'Priority'},
                    {
                        ...
                        render: function(data) {
                            if (data === 'completed') {
                                return '<span class="badge badge-success m-2">{{ __("translate.Completed") }}</span>';
                            } else if (data === 'not_started') {
                                return '<span class="badge badge-warning m-2">{{ __("translate.Not_Started") }}</span>';
                            } else if (data === 'progress') {
                                return '<span class="badge badge-primary m-2">{{ __("translate.In_Progress") }}</span>';
                            } else if (data === 'cancelled') {
                                return '<span class="badge badge-danger m-2">{{ __("translate.Cancelled") }}</span>';
                            } else if (data === 'hold') {
                                return '<span class="badge badge-secondary m-2">{{ __("translate.On_Hold") }}</span>';
                            }
                            return data;
                        }
                    },
