...
<script type="text/javascript">
    $(function () {
      "use strict";
        ...
        // Initialize company table with mobile configuration
        window.DataTablesMobileConfig.initTable('#company_list_table', 'default', {
            order: [[1, 'asc']], // Sort by company name
            columnDefs: [
                { targets: 0, className: 'select-checkbox', responsivePriority: 1 },
                { targets: 1, responsivePriority: 1 }, // Company name
                { targets: 2, responsivePriority: 2 }, // Email
                { targets: 3, responsivePriority: 3 }, // Phone
                { targets: 4, responsivePriority: 10000 }, // Country
