...
<script type="text/javascript">
    $(function () {
      "use strict";
        ...
        // Initialize leave table with mobile configuration
        window.DataTablesMobileConfig.initTable('#leave_list_table', 'hr', {
            order: [[1, 'asc']], // Sort by employee name
            columnDefs: [
                { targets: 0, className: 'select-checkbox', responsivePriority: 1 },
                { targets: 1, responsivePriority: 1 }, // Employee
                { targets: 2, responsivePriority: 10000 }, // Company
                { targets: 3, responsivePriority: 3 }, // Department
                { targets: 4, responsivePriority: 4 }, // Leave type
                { targets: 5, responsivePriority: 10001 }, // Start date
                { targets: 6, responsivePriority: 10002 }, // End date
                { targets: 7, responsivePriority: 5 }, // Days
